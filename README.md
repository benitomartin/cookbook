...
| Name | Description | Link |
|------|-------------|------|
| Image Classification on Edge | End-to-end tutorial covering fine-tuning and deployment for super fast and accurate image classification using local VLMs | [![GitHub](https://img.shields.io/github/stars/Paulescu/image-classification-with-local-vlms?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/Paulescu/image-classification-with-local-vlms) |
| Chess Game with Small LMs | End-to-end tutorial covering fine-tuning and deployment to build a Chess game using Small Language Models | [![GitHub](https://img.shields.io/github/stars/Paulescu/chess-game?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/Paulescu/chess-game) |
| TranslatorLens | Offline translation camera for real-time text translation | [![GitHub](https://img.shields.io/github/stars/linmx0130/TranslatorLens?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/linmx0130/TranslatorLens) |
| Food Images Fine-tuning | Fine-tune LFM models on food image datasets | [![GitHub](https://img.shields.io/github/stars/benitomartin/food-images-finetuning?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/benitomartin/food-images-finetuning) |
| Meeting Intelligence CLI | CLI tool for meeting transcription and analysis | [![GitHub](https://img.shields.io/github/stars/chintan-projects/meeting-prompter?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/chintan-projects/meeting-prompter) |
| Private Doc Q&A | On-device document Q&A with RAG and voice input | [![GitHub](https://img.shields.io/github/stars/chintan-projects/private-doc-qa?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/chintan-projects/private-doc-qa) |
| Photo Triage Agent | Private photo library cleanup using LFM vision model | [![GitHub](https://img.shields.io/github/stars/chintan-projects/photo-triage-agent?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/chintan-projects/photo-triage-agent) |
| LFM-Scholar | Automated literature review agent for finding and citing papers | [![GitHub](https://img.shields.io/github/stars/gyunggyung/LFM-Scholar?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/gyunggyung/LFM-Scholar) |
| LFM2-KoEn-Tuning | Fine-tuned LFM2 1.2B for Korean-English translation | [![GitHub](https://img.shields.io/github/stars/gyunggyung/LFM2-KoEn-Tuning?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/gyunggyung/LFM2-KoEn-Tuning) |
| Chat with LEAP SDK | LEAP SDK integration for React Native | [![GitHub](https://img.shields.io/github/stars/glody007/expo-leap-sdk?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/glody007/expo-leap-sdk) |
| Private Summarizer | 100% local text summarization with multi-language support | [![GitHub](https://img.shields.io/github/stars/Private-Intelligence/private_summarizer?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/Private-Intelligence/private_summarizer) |
| Tiny-MoA | Mixture of Agents on CPU with LFM2.5 Brain (1.2B) | [![GitHub](https://img.shields.io/github/stars/gyunggyung/Tiny-MoA?style=for-the-badge&logo=github&label=View%20Repository&color=black)](https://github.com/gyunggyung/Tiny-MoA) |
